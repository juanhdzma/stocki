...
class MarketSnapshot(Base):
    ...
    data_json: Mapped[str] = mapped_column(Text)
    refreshed_at: Mapped[str] = mapped_column(String(30))
...
class ScoresCache(Base):
    ...
    computed_at: Mapped[str] = mapped_column(String(30))
...
class Watchlist(Base):
    ...
    added_at: Mapped[str] = mapped_column(String(30), server_default="")
